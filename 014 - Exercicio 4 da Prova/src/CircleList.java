...
public class CircleList {
    ...
    // Função para checar se duas lista circulares são iguais
    public static boolean isEqualCircleList(CircleList list1, CircleList list2) {
        if (list1.size == 0 && list2.size == 0) {
            ...
            if (list1.size() != list2.size()) {
                ...
                Node cursor_1 = list1.getCursor();
                Node cursor_2 = list2.getCursor();

                int qtd_interacoes = 0;

                while (!(cursor_1.getElement().equals(cursor_2.getElement())) && (qtd_interacoes < list2.size())) {
                ...
                for (int i = 0; i < list2.size(); i++) {
                    ...
                    cursor_2 = cursor_2.getNext();
                    if (!cursor_1.getElement().equals(cursor_2.getElement())) {
                        return false;
                    }
                }
                return true;
