...
//begin#fragment checkPosition
    ...
    protected DNode<E> checkPosition(Position<E> p)
        ...
        if (p == null) {
            throw new IllegalArgumentException("Null position passed to NodeList");
        }
        if (p == header) {
            throw new IllegalArgumentException("The header node is not a valid position");
        }
        if (p == trailer) {
            throw new IllegalArgumentException("The trailer node is not a valid position");
        }
        try {
            DNode<E> temp = (DNode<E>) p;
            if ((temp.getPrev() == null) || (temp.getNext() == null)) {
                throw new IllegalArgumentException("Position does not belong to a valid NodeList");
            }
            return temp;
        } catch (ClassCastException e) {
            throw new IllegalArgumentException("Position is of wrong type for this list");
        }
    }
    ...
    public Position<E> prev(Position<E> p)
        ...
        if (prev == header) {
            throw new IllegalArgumentException("Cannot advance past the beginning of the list");
        }
        return prev;
    }
    //end#fragment first
    ...
    public Position<E> next(Position<E> p)
        ...
        if (next == trailer) {
            throw new IllegalArgumentException("Cannot advance past the end of the list");
        }
        return next;
    }
    //begin#fragment first
